...
SELECT e.FName, e.LName, e.MName FROM Employees e
INNER JOIN OrderDetails od ON e.EmployeeID = od.OrderID
WHERE TotalPrice > 1000;

SELECT  c.FName, c.LName, c.MName FROM CUstomers c
INNER JOIN OrderDetails od ON c.CustomerNo = od.OrderID
WHERE TotalPrice > 1000;
